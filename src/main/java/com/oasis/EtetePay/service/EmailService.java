...
import com.oasis.EtetePay.exception.EmailDeliveryException;
...
public class EmailService {
    ...
    public void sendVerificationEmail(String to, String verificationToken){
        ...
        <body style="font-family: Arial, sans-serif; line-height: 1.6;">
            ...
            <h2>Welcome to EtetePay</h2>

            <p>
                Thank you for registering with EtetePay.
            </p>
    ...
    public void sendForgotPassEmail(String to, String resetToken){
        ...
        <body style="font-family: Arial, sans-serif; line-height: 1.6;">
            ...
            <h2>Reset your EtetePay account password with the below options.</h2>
    ...
    public void sendPassResetConfirmationEmail(String to){
        ...
        <body style="font-family: Arial, sans-serif; line-height: 1.6;">
            ...
            <h2>Your EtetePay account password has been successfully changed.</h2>
