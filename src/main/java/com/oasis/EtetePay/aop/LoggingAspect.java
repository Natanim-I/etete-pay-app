package com.oasis.EtetePay.aop;
...
public class LoggingAspect {
    ...
    @AfterThrowing(value = "execution(* com.oasis.EtetePay.service..*(..))", throwing = "ex")
    ...
    @AfterReturning(value = "execution(* com.oasis.EtetePay.service..*(..))")
    ...
    @AfterReturning(value = "execution(* com.oasis.EtetePay.service.UserService.registerUser(..))", returning = "result")
    ...
    @AfterReturning(value = "execution(* com.oasis.EtetePay.service.WalletService.createUserWallet(..))", returning = "result")
    ...
    @AfterReturning(value = "execution(* com.oasis.EtetePay.service.WalletService.disableUserWallet(..))")
    ...
    @AfterReturning(value = """
             execution(* com.oasis.EtetePay.service.TransactionService.deposit(..) || 
             execution(* com.oasis.EtetePay.service.TransactionService.withdraw(..)
             """, returning = "result")
    ...
    @AfterReturning(value = "execution(* com.oasis.EtetePay.service.TransactionService.transfer(..)", returning = "result")
    ...
    @AfterReturning(value = "execution(* com.oasis.EtetePay.service.TransactionService.exchange(..)", returning = "result")
    ...
    @AfterReturning(value = "* com.oasis.EtetePay.service.BudgetService.createBudget(..)", returning = "result")
    ...
    @AfterReturning(value = "* com.oasis.EtetePay.service.BudgetService.updateBudget(..)", returning = "result")
    ...
    @AfterReturning(value = "* com.oasis.EtetePay.service.BudgetService.updateBudget(..)")
